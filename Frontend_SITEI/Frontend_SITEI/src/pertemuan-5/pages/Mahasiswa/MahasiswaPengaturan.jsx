...
export default function MahasiswaPengaturan() {
  ...
  const handleSaveProfile = async (e) => {
    ...
    try {
      ...
      // Memicu sinkronisasi instan ke Navbar lewat storage event
        ...
        <div className="xl:col-span-1 space-y-6">
          <div className="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 flex flex-col items-center text-center">
            ...
            <div className="mt-8 w-full pt-5 border-t border-slate-100 space-y-3">
              ...
              <div className="flex justify-between items-center text-xs">
                <span className="text-slate-400 font-bold uppercase tracking-wide">Program Studi</span>
                <span className="font-extrabold text-[#003178]">{profile?.department || "Anestesiologi"}</span>
              </div>
            </div>
          </div>
        </div>
